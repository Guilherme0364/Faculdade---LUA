...
function configQuadro()
  ...
  -- Área piso cinza
  quadros[1] = Q(2 * quadro, 0*quadro, quadro, quadro, qdImagem:getWidth(), qdImagem:getHeight())
  
  -- Área piso marrom
  quadros[2] = Q(4 * quadro, 0*quadro, quadro, quadro, qdImagem:getWidth(), qdImagem:getHeight())
  
  -- Área tapete vermelho
  quadros[3] = Q(3 * quadro, 9*quadro, quadro, quadro, qdImagem:getWidth(), qdImagem:getHeight())
